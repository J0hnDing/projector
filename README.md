...
- Render `README.md`, startup scripts and instructions from `STARTUP.md`, `TODO.md`, and work history (`WORK_HISTORY.md` or `WORKING_HISTORY.md`) from either the project root or `docs/`, using case-insensitive filename matching. HTTP(S) links in the Startup tab open in the system default browser.
